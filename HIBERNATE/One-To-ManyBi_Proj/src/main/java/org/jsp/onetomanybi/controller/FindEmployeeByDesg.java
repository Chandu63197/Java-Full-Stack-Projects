...
public class FindEmployeeByDesg {
	public static void main(String[] args) {
		...
		System.out.println("Enter the Designation to fetch Employee details");
		String desg = sc.next();
		EntityManager manager = Persistence.createEntityManagerFactory("dev").createEntityManager();
		String qry1 = "select e from Employee e where e.desg=?1";
		...
		if (emps.size() > 0) {
			...
			System.out.println("Entered an Invalid Employee Designation");
		}
		sc.close();
	}
}
